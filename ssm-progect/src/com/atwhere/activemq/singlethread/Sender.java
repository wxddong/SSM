package com.atwhere.activemq.singlethread;
...
public class Sender {
	...
	private static final int SEND_NUMBER = 6;

	public static void main(String[] args) {
		//ConnectionFactory:连接工厂，JMS用她创建连接
		ConnectionFactory connectionFactory;
		//connection : JMS 客户端到JMS Provider(供应者) 的连接
		Connection connection = null;
		//Session : 一个发送或者接受消息的线程
		Session session;
		// Destination(queue) ：消息的目的地;消息发送给谁.queue
