...
import com.atwhere.p2p.util.DateFormatHelper;
...
public class CustomerController 
{
	...
	public String toList(@ModelAttribute("wm") CustomerWebModel wm,Model model,HttpServletRequest request)	
	{
		...
		if(null == wm.getQueryJsonStr() || wm.getQueryJsonStr().trim().length() == 0)
		{
			...
			cqm = (CustomerQueryModel)JsonUtil.str2Object(wm.getQueryJsonStr(),CustomerQueryModel.class);
		}
	...
	public void testMysql(Student student){
		System.out.println(student);
		customerService.addStudetn(student);
	}
}
